    ...
    <>
      <div className='relative pt-7 mt-20 pl-4 pb-24 lg:space-y-24 lg:pl-16'>
          <section className={`md:space-y-24`}>
            <Row title="Sci-Fi Movies" movies={sciFiMovies} search="sciFiMovies" />
            <Row title="Mystery Movies" movies={mysteryMovies} search="mysteryMovies" />
            <Row title="War Movies" movies={warMovies} search="warMovies" />
            <Row title="Crime" movies={crimeMovies} search="crimeMovies" />
            <Row title="Animated" movies={animatedMovies} search="animatedMovies" />
